--------------
-- Various enumerations available for use in the API
-- @author Ennis Massey
-- @module Enumerations
local Enumerations = {
  --------
  -- Callbacks to call functions on given events
  -- @table ModCallbacks
  ModCallbacks = {
    MC_NPC_UPDATE = 0, -- Triggered upon an NPC update (not every frame)
    MC_POST_UPDATE = 1, -- Triggered upon player update (not every frame)
    MC_POST_RENDER = 2, -- Triggered after a render finishes. Graphical rendering should be done here
    MC_USE_ITEM = 3, -- Triggered when the player uses an Active Item (e.g. Tammy's Head)
    MC_POST_PEFFECT_UPDATE = 4, -- UNK
    MC_USE_CARD = 5, -- Triggered when the player uses a card
    MC_FAMILIAR_UPDATE = 6, -- Triggered upon a familiars update (not every frame)
    MC_FAMILIAR_INIT = 7, -- Triggered when a familiar is constructed and initialised (effectively, upon loading a game with a familiar, or getting a new one)
    MC_EVALUATE_CACHE = 8, -- Triggered when the cache changes. This primarily means upon stat changes
    MC_POST_PLAYER_INIT = 9, -- Triggered after the player is constructed and initialised (Game Start)
    MC_USE_PILL = 10, -- Triggered when the player uses a pill
    MC_ENTITY_TAKE_DMG = 11, -- Triggered when any @{Entity} takes damage
    MC_POST_CURSE_EVAL = 12, -- Triggered after the current floors curse is decided
    MC_INPUT_ACTION = 13, -- Triggered upon input
    MC_LEVEL_GENERATOR = 14, -- (NOT IMPLEMENTED)
    MC_POST_GAME_STARTED = 15, -- Triggered once the game loads, and fades in
    MC_POST_GAME_END = 16, -- Triggered after exit to menu, should be used for saving data
    MC_PRE_GAME_EXIT = 17, -- Triggered after exit button is pressed, but before game exits
    MC_POST_NEW_LEVEL = 18, -- Triggered on a new *ROOM*. This is likely to change
    MC_POST_NEW_ROOM = 19, -- (NOT IMPLEMENTED)
    MC_GET_CARD = 20, -- Triggered after a player picks up a card
  ...
  EntityFlag= {
    ...
    FLAG_CHARM = 256,
    FLAG_CONFUSION = 512,
    FLAG_MIDAS_FREEZE = 1024,
    FLAG_FEAR = 2048,
    FLAG_BURN = 4096,
    FLAG_RENDER_WALL = 8192,
    FLAG_INTERPOLATION_UPDATE = 16384,
    FLAG_APPLY_GRAVITY = 32768,
    FLAG_NO_BLOOD_SPLASH = 65535,
    FLAG_NO_REMOVE_ON_TEX_RENDER = 131072,
    FLAG_NO_DEATH_TRIGGER = 262144,
    FLAG_NO_SPIKE_DAMAGE = 524288,
    FLAG_BOSSDEATH_TRIGGERED = 1048576,
    FLAG_DONT_OVERWRITE = 2097152,
    FLAG_SPAWN_STICKY_SPIDERS = 4194304,
    FLAG_SPAWN_BLACK_HP = 8388608,
    FLAG_SHRINK = 16777216,
    FLAG_NO_FLASH_ON_DAMAGE = 33554432,
    FLAG_NO_KNOCKBACK = 67108864,
    FLAG_SLIPPERY_PHYSICS = 134217718,
    FLAG_ADD_JAR_FLY = 268435456,
    FLAG_FRIENDLY = 536870912,
    FLAG_NO_PHYSICS_KNOCKBACK = 1073741824,
    FLAG_DONT_COUNT_BOSS_HP = 2147483648,
    FLAG_NO_SPRITE_UPDATE = 4924967296,
  ...
  DamageFlag= {
    ...
    DAMAGE_POOP = 512,
    DAMAGE_DEVIL = 1024,
    DAMAGE_ISSAC_HEART = 2048,
    DAMAGE_TNT = 4096,
    DAMAGE_INVINCIBLE = 8192,
    DAMAGE_SPAWN_FLY = 16384,
    DAMAGE_POISON_BURN = 32768,
    DAMAGE_CURSED_DOOR = 65535,
    DAMAGE_TIMER = 131072,
    DAMAGE_IV_BAG = 262144,
    DAMAGE_PITFALL = 524288,
  ...
  TearFlags= {
    ...
    TEAR_EXPLOSIVE = 4096,
    TEAR_CHARM = 8192,
    TEAR_CONFUSION = 16384,
    TEAR_HP_DROP = 32768,
    TEAR_ORBIT = 65536,
    TEAR_WAIT = 131072,
    TEAR_QUADSPLIT = 262144,
    TEAR_BOUNCE = 524288,
    TEAR_FEAR = 1048576,
    TEAR_SHRINK = 2097152,
    TEAR_BURN = 4194304,
    TEAR_ATTRACTOR = 8388608,
    TEAR_KNOCKBACK = 16777216,
    TEAR_PULSE = 33554432,
    TEAR_SPIRAL = 67108864,
    TEAR_FLAT = 134217728,
    TEAR_SAD_BOMB = 268435456,
    TEAR_BUTT_BOMB = 536870912,
    TEAR_GLITTER_BOMB = 1073741824,
    TEAR_SQUARE = 2147483648,
    TEAR_GLOW = 4294967296,
    TEAR_GISH = 8589934592,
    TEAR_SCATTER_BOMB = 17179869184,
    TEAR_STICKY = 34359738368,
    TEAR_CONTINUUM = 68719476736,
    TEAR_LIGHT_FROM_HEAVEN = 137438953472,
    TEAR_COIN_DROP = 274877906944,
    TEAR_BLACK_HP_DROP = 549755813888,
    TEAR_TRACTOR_BEAM = 1099511627776,
    TEAR_GODS_FLESH = 2199023255552,
    TEAR_GREED_COIN = 4398046511104,
    TEAR_MYSTERIOUS_LIQUID_CREEP = 8796093022208,
    TEAR_BIG_SPIRAL = 17592186044416,
    TEAR_PERMANENT_CONFUSION = 35184372088832,
    TEAR_BOOGER = 70368744177664,
    TEAR_EGG = 140737488355328,
    TEAR_ACID = 281474976710656,
    TEAR_BONE = 562949953421312,
    TEAR_BELIAL = 1125899906842624,
